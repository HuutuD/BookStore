        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationShip = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserSubmitId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shippings_Users_UserSubmitId",
                        column: x => x.UserSubmitId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shippings_UserSubmitId",
                table: "Shippings",
                column: "UserSubmitId");
        }
